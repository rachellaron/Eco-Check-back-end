...
INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Soft Drink Bottle', '1 PET', '/recycle-bin.png', 'These items are a rigid/hard plastic, they can be recycled through your recycling bin.  However if you can, avoid purchasing plastic bottles and choose to use re-usable, refillable or glass  bottles instead.', 'Water, soft drink and  sport drink bottles, condiment bottles, peanut butter, vegemite and jam jars.', 'Recycle Bin');

INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Peanut Butter, Jam and Vegemite Jars', '1 PET', '/recycle-bin.png', 'These items are a rigid/hard plastic, they can be recycled through your recycling bin.  However if you can, avoid purchasing plastic bottles and choose to use re-usable, refillable or glass  bottles instead.', 'Water, soft drink and  sport drink bottles, condiment bottles, peanut butter, vegemite and jam jars.', 'Recycle Bin');
...
INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Juice Bottle', '2 HDPE', '/recycle-bin.png', 'The rigid/hard plastic items can be recycled through your recycling bin. However lightweight soft plastic grocery bags cannot be recycled in the recycling bin. They get caught up in the machinery at the materials recycling facility (MRF) and mix with other materials such as paper. Please dispose of these at your local store or in your waste bin.', 'Milk and juice bottles, detergent, shampoo and conditioner bottles, water pipes and grocery bags.', 'Recycle Bin');

INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Detergent, Shampoo & Conditioner Bottles', '2 HDPE', '/recycle-bin.png', 'The rigid/hard plastic items can be recycled through your recycling bin. However lightweight soft plastic grocery bags cannot be recycled in the recycling bin. They get caught up in the machinery at the materials recycling facility (MRF) and mix with other materials such as paper. Please dispose of these at your local store or in your waste bin.', 'Milk and juice bottles, detergent, shampoo and conditioner bottles, water pipes and grocery bags.', 'Recycle Bin');
...
INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Cordial Bottle (Clear)', '3 PVC', '/recycle-bin.png', 'The rigid/hard plastic items can be recycled through your recycling bin. Soft plastics, mats and flooring cannot be recycled in the recycling bin. Please dispose of these at your local store or in your waste bin.', 'Flexible or rigid plastic used for plumbing pipes, clear cordial and juice bottles, bubble wrap, children’s toys and play mats, tablecloths, and vinyl flooring.', 'Recycle Bin');

INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Bubble Wrap', '3 PVC', '/recycle-bin.png', 'The rigid/hard plastic items can be recycled through your recycling bin. Soft plastics, mats and flooring cannot be recycled in the recycling bin. Please dispose of these at your local store or in your waste bin.', 'Flexible or rigid plastic used for plumbing pipes, clear cordial and juice bottles, bubble wrap, children’s toys and play mats, tablecloths, and vinyl flooring.', 'Recycle Bin');
...
INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Produce Bags', '4 LDPE', '/waste-bin.png', 'Lightweight soft plastic bags cannot be recycled  in the yellow lidded recycling bin. They get caught up in the machinery at the materials recycling facility (MRF) and mix with other materials such as paper. You can recycle them at REDcycle Bins at Woolworths or Coles.', 'Bread bags, dry cleaning bags, newspaper bags, produce bags and bin liner bags as well as a lining in milk cartons and takeaway beverage cups.', 'Waste Bin');

INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Bin Liner Bags', '4 LDPE', '/waste-bin.png', 'Lightweight soft plastic bags cannot be recycled  in the yellow lidded recycling bin. They get caught up in the machinery at the materials recycling facility (MRF) and mix with other materials such as paper. You can recycle them at REDcycle Bins at Woolworths or Coles.', 'Bread bags, dry cleaning bags, newspaper bags, produce bags and bin liner bags as well as a lining in milk cartons and takeaway beverage cups.', 'Waste Bin');

INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Takeaway Beverage Cups', '4 LDPE', '/waste-bin.png', 'Lightweight soft plastic bags cannot be recycled  in the yellow lidded recycling bin. They get caught up in the machinery at the materials recycling facility (MRF) and mix with other materials such as paper. You can recycle them at REDcycle Bins at Woolworths or Coles.', 'Bread bags, dry cleaning bags, newspaper bags, produce bags and bin liner bags as well as a lining in milk cartons and takeaway beverage cups.', 'Waste Bin');
...
INSERT INTO products (product_name, recycle_number, image, info, common_form, bin_info) VALUES ('Plastic Takeaway Containers', '5 PP', '/recycle-bin.png', 'Rigid hard plastic containers can be recycled. Bottle caps can be placed in loose.', 'Ice cream containers and lids, yoghurt , margarine and  butter containers, juice bottles, bottle caps, straws, plant pots and plastic takeaway containers.', 'Recycle Bin');
